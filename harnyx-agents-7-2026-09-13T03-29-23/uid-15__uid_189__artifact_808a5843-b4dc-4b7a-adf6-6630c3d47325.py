...
def _compose_branch0_b886_d94_d3_e3_entry():
...
_branch0_b886_d94_d3_e3_query_entry = _compose_branch0_b886_d94_d3_e3_entry()
...
class Branch0B886D94D3E3:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch0_b886_d94_d3_e3_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = Branch34534862AA95()
_MODE_SHAPE_SECONDARY_AGENT = BranchB31669D8E370()
_MODE_SHAPE_TERTIARY_AGENT = Branch0B886D94D3E3()
_CANDIDATE_BRANCH_CLASS_NAMES = ("Branch34534862AA95", "BranchB31669D8E370", "Branch0B886D94D3E3")
