...
def _compose_branch_c0_f800036_e0_c_entry():
...
_branch_c0_f800036_e0_c_query_entry = _compose_branch_c0_f800036_e0_c_entry()
...
class BranchC0F800036E0C:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch_c0_f800036_e0_c_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = BranchE859318BEE72()
_MODE_SHAPE_SECONDARY_AGENT = BranchE840DB991160()
_MODE_SHAPE_TERTIARY_AGENT = BranchC0F800036E0C()
_CANDIDATE_BRANCH_CLASS_NAMES = ("BranchE859318BEE72", "BranchE840DB991160", "BranchC0F800036E0C")
