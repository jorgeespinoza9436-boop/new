...
def _compose_branch_f0_d_d_f_d_d2664_a_entry():
...
_branch_f0_d_d_f_d_d2664_a_query_entry = _compose_branch_f0_d_d_f_d_d2664_a_entry()
...
_CORE_FIRST_SPECIALIST_MODES = {'normal_text': False, 'normal_structured': True, 'fast_text': True, 'fast_structured': False}
...
class BranchF0DDFDD2664A:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch_f0_d_d_f_d_d2664_a_query_entry(query=query)
...
_MODE_SHAPE_PRIMARY_AGENT = BranchF0DDFDD2664A()
_MODE_SHAPE_SECONDARY_AGENT = BranchB31669D8E370()
_MODE_SHAPE_TERTIARY_AGENT = Branch82204358CF64()
_CANDIDATE_BRANCH_CLASS_NAMES = ("BranchF0DDFDD2664A", "BranchB31669D8E370", "Branch82204358CF64")
