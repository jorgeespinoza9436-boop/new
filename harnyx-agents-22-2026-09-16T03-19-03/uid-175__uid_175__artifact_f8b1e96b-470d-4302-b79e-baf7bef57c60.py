...
def _compose_branch15_b01_e0_d05_f2_entry():
...
_branch15_b01_e0_d05_f2_query_entry = _compose_branch15_b01_e0_d05_f2_entry()


def _compose_branch_a3_d75_c_d67233_entry():
...
_branch_a3_d75_c_d67233_query_entry = _compose_branch_a3_d75_c_d67233_entry()
...
class Branch15B01E0D05F2:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch15_b01_e0_d05_f2_query_entry(query=query)


class BranchA3D75CD67233:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch_a3_d75_c_d67233_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = BranchE859318BEE72()
_MODE_SHAPE_SECONDARY_AGENT = Branch15B01E0D05F2()
_MODE_SHAPE_TERTIARY_AGENT = BranchA3D75CD67233()
_CANDIDATE_BRANCH_CLASS_NAMES = ("BranchE859318BEE72", "Branch15B01E0D05F2", "BranchA3D75CD67233")
