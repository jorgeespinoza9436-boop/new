...
def _compose_meadow_compass_agent_entry():
...
_meadow_compass_agent_query_entry = _compose_meadow_compass_agent_entry()


_SHAPE_ROUTER_SEED = "b5a4e6a70122ab3571647b5b"
...
class MeadowCompassAgent:
    async def __call__(self, query: Query) -> Response:
        return await _meadow_compass_agent_query_entry(query)


_SHAPE_PRIMARY_AGENT = FrostLanternAgent()
_SHAPE_SECONDARY_AGENT = LumenAnvilAgent()
_SHAPE_TERTIARY_AGENT = MeadowCompassAgent()
