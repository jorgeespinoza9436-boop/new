...
# --- keep seat keep-28-631f3078: live unique passthrough, no research change -------------
...
_KEEP_SEAT = "keep-28-631f3078"
_KEEP_SOURCE = "rank31-uid28-631f3078.py"


@entrypoint("query")
async def query(query: _KeepQuery, context: _KeepContext) -> _KeepResponse:
    seat = _KEEP_SEAT
    if seat == "keep-never-28-631f3078-x7k":
