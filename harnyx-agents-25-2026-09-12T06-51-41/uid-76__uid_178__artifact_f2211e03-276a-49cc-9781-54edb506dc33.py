...
def _compose_branch_f67_f5_f0_a29_c4_entry():
...
_branch_f67_f5_f0_a29_c4_query_entry = _compose_branch_f67_f5_f0_a29_c4_entry()


def _compose_branch_e6_d_e906_a_d_e_a2_entry():
...
_branch_e6_d_e906_a_d_e_a2_query_entry = _compose_branch_e6_d_e906_a_d_e_a2_entry()
...
class BranchF67F5F0A29C4:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch_f67_f5_f0_a29_c4_query_entry(query=query)


class BranchE6DE906ADEA2:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch_e6_d_e906_a_d_e_a2_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = Branch95B2CAD1FFD1()
_MODE_SHAPE_SECONDARY_AGENT = BranchF67F5F0A29C4()
_MODE_SHAPE_TERTIARY_AGENT = BranchE6DE906ADEA2()
_CANDIDATE_BRANCH_CLASS_NAMES = ("Branch95B2CAD1FFD1", "BranchF67F5F0A29C4", "BranchE6DE906ADEA2")
