...
def _compose_branch9_c42278_a56_b1_entry():
...
_branch9_c42278_a56_b1_query_entry = _compose_branch9_c42278_a56_b1_entry()
...
class Branch9C42278A56B1:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch9_c42278_a56_b1_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = Branch82204358CF64()
_MODE_SHAPE_SECONDARY_AGENT = Branch0B405CAEC72B()
_MODE_SHAPE_TERTIARY_AGENT = Branch9C42278A56B1()
_CANDIDATE_BRANCH_CLASS_NAMES = ("Branch82204358CF64", "Branch0B405CAEC72B", "Branch9C42278A56B1")
