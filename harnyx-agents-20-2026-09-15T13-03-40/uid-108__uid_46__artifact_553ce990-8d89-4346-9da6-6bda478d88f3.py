...
def _compose_branch22_d5_c3_b66_b26_entry():
...
_branch22_d5_c3_b66_b26_query_entry = _compose_branch22_d5_c3_b66_b26_entry()
...
class Branch22D5C3B66B26:
    async def __call__(self, query: Query, context: ContextSnapshot) -> Response:
        return await _branch22_d5_c3_b66_b26_query_entry(query=query)


_MODE_SHAPE_PRIMARY_AGENT = Branch0B405CAEC72B()
_MODE_SHAPE_SECONDARY_AGENT = Branch24ACBE3AF69D()
_MODE_SHAPE_TERTIARY_AGENT = Branch22D5C3B66B26()
_CANDIDATE_BRANCH_CLASS_NAMES = ("Branch0B405CAEC72B", "Branch24ACBE3AF69D", "Branch22D5C3B66B26")
