...
def _compose_willow_4235f9_alpha():
...
def _compose_willow_4235f9_beta():
...
_LANE_A_4235F9 = _compose_willow_4235f9_alpha()
_LANE_B_4235F9 = _compose_willow_4235f9_beta()
...
async def query(query: Query) -> Response:
    ...
    if selected == 'schema':
        try:
            return _contract_response(query, await _LANE_B_4235F9(query))
        except Exception:
            pass
        ...
        try:
            return _contract_response(query, await _LANE_A_4235F9(query))
        except Exception:
            pass
    try:
        return _contract_response(query, await _LANE_A_4235F9(query))
