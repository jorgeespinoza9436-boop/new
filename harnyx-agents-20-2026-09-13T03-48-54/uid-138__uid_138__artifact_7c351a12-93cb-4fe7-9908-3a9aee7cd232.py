...
_SHAPE_ROUTER_SEED = "bb0ec3f607e4e1eed7b0e37a"
...
_SHAPE_PRIMARY_AGENT = JuniperCompassAgent()
_SHAPE_SECONDARY_AGENT = BasaltLatticeAgent()
...
async def query(query: Query) -> Response:
    ...
    if selected == "JuniperCompassAgent":
        try:
